Sub Scanner()
  ...
  ' Make sure to change de défault Line.
    ...
    For i = 2 To 1000
       ...
       Next i
    ' ---------------------- Attention, I use in the rest of the code this function ( https://github.com/Niffty0/Public_VBA/blob/main/Data2TextFile/Data2TextFile.vba ) But you can delete what is underneath if you do not need it ----------------------
       data_to_text_file (sPreviousSalle)
    ' ----------------------      ----------------------      ----------------------
